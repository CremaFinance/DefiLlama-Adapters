...
const NFTVoteMNDECard = () => {
  ...
  return (
    ...
    >
      ...
      >
        {t("appPage.mnde.nft-vote-card.title")}
      </Text>
      <Text
        marginTop="8px"
        ...
        color={colors.blackMate}
      >
        {t("appPage.mnde.nft-vote-card.description")}
      </Text>
      <Flex marginTop={{ base: "24px", md: "10px", xl: "24px" }} width="100%">
        <MButton
          ...
          paddingX="44px"
        >
          {t("appPage.mnde.nft-vote-card.button")}
          <Icon
            as={FiExternalLink}
            width="16px"
            height="16px"
...
export default NFTVoteMNDECard;
